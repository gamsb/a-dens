...
class AuctionTest_with_three_bidders(AuctionTest): 
    ...
    def test_second_bidder_wins_auction_with_12(self):        
        ...
        bidder3.call_method('payBid', dict(auction = self.addr, bid_value = 11 * ts4.GRAM))
        ...
        self.assertEqual(11 * ts4.GRAM, bidder3.call_getter('m_last_received'))
